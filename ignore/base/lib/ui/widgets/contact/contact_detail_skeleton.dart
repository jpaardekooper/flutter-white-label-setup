    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          ...
          left: width / 2 - 70,
          child:
              ContactSocialmediaIcons(buttonType: SocialMediaButton.linkedIn),
        ),
        //twitter
        Positioned(
          top: top - 20,
          ...
          child: ContactSocialmediaIcons(buttonType: SocialMediaButton.twitter),
        ),
        Positioned(
          top: top - 20,
          right: width / 2 - 70,
          child:
              ContactSocialmediaIcons(buttonType: SocialMediaButton.facebook),
        ),
      ],
    );
  }
